  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-8">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications, Ganesh excels in
      ...
      <span>
       Ganesh is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, Ganesh is a big fan of cricket and
        holds immense admiration for <strong> MS.Dhoni</strong> His favorite
        person and biggest inspiration is his brother,{" "}
        <strong>Mayur.</strong> Their friendly rivalry and deep bond have
        significantly shaped Ganesh’s journey. Ganesh is not only a great
        competitor but also a steadfast friend, constantly motivating Ganesh to
