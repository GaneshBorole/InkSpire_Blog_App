    ...
    <>
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className=" text-center md:text-start">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white">
                  ITCompany vs Appsmith
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-white">
                ITCompany vs FlutterFlow
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-white">
                  ITCompany vs Monday Hero
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-white">
      ...
      <div className=" container mx-auto  flex flex-col md:flex-row justify-between items-center">
        <div className="text-xl font-semibold hidden md:flex">
          Ink<span className="text-blue-500 font-bold">Spire</span>
        </div>
        <div className="text-gray-400 text-sm hidden md:flex">
          <p>&copy; 2026 ITCompany PVT. LTD. All rights reserved</p>
        </div>
